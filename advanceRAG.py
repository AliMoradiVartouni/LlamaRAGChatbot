...
class RAGChat:
    def __init__(self, model_dir: str):
        ...
        self.context_window = 4096  # TinyLlama's max context window
    ...
    def setup_query_engine(self):
        ...
        # Setup vector store
        db = chromadb.PersistentClient(path="./chroma_db_advanced")
        ...
        qa_template = PromptTemplate(
            "Based on the information provided below, give a single, concise answer.\n"
            "---------------------\n"
            "{context_str}\n"
            "---------------------\n"
            "Question: {query_str}\n"
        ...
        # Refinement template
        qa_refine_template = PromptTemplate(
            "The original query: {query_str}\n"
            "Existing answer: {existing_answer}\n"
            "Additional context is provided below. Refine the answer only if the new context improves it.\n"
            "------------\n"
            "{context_msg}\n"
            "------------\n"
            "Refined Answer: "
